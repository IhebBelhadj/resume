...
\begin{onecolentry}
Software engineer who enjoys looking at the frontend from a backend engineer’s perspective, focusing on performance, scalability, and optimizations to deliver seamless user experiences.
\end{onecolentry}
...
\begin{onecolentry}
\textbf{Testing:} Jasmin, Karma, Jest, Playwright
\end{onecolentry}
...
\begin{onecolentry}
  \textbf{Infrastructure \& DevOps:} Docker, Kubernetes, SonarQube, Nginx, Ansible, Vagrant, Jenkins, GitHub Actions, AWS
\end{onecolentry}
...
\begin{onecolentry}
  ...
  \item Built a Next.js frontend leveraging WebSockets to deliver instant feedback and live chart updates for a seamless user experience.
\item Optimized frontend performance with persisted state to reduce network calls and enable offline viewing, and implemented optimistic updates for a faster, more responsive user experience.
...
\item Contributed to a frontend platform by building reusable components and a hybrid state management system with route-based state and Zustand, optimizing load times and UX.
...
\begin{onecolentry}
  \begin{highlights}
  \item \textbf{Portfolio:} Built on Next.js with MDX-based content management, lazy loading, and server components. Integrated a LangChain agent that answers questions about me. Achieved 100 performance and best practices scores on Lighthouse.
  \end{highlights}
\end{onecolentry}
...
\begin{onecolentry}
  \begin{highlights}
  \item \textbf{\href{https://ihebbelhadj.vercel.app/projects/elder_care_saas}{EldSync:}} Contributed to the frontend development of a Java microservices platform, building Angular components with Apollo Client and NgRx for state management, integrated with Spring Boot backend services.
  \end{highlights}
\end{onecolentry}
