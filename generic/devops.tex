...
\begin{onecolentry}
Software engineer specializing in backend systems and DevOps practices. Experienced in building scalable software, designing and automating CI/CD pipelines, managing cloud infrastructure, and ensuring reliable, reproducible deployments.
\end{onecolentry}
...
\begin{onecolentry}
\textbf{Languages:} TypeScript, Python, JavaScript, Java, C\#, C, SQL, PHP, Bash, Groovy, Lua
\end{onecolentry}
...
\begin{onecolentry}
  \textbf{Infrastructure \& DevOps:} Docker, Kubernetes, Ansible, Vagrant, Jenkins, GitHub Actions, AWS
\end{onecolentry}
...
\item Built and deployed an end-to-end data pipeline with Airflow and dbt on Dockerized infrastructure, ensuring reproducible workflows and enabling easy scaling of replicas under load.
\item Automated deployments via GitHub webhooks and Bash scripts on a Docker Compose cluster, improving release consistency.
